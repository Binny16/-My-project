...
//to create beans
	...
	public DataSource getDataSource() {
	    ...
	    dataSource.setUrl("jdbc:h2:tcp://localhost/~/online_shopping_backend");
	    dataSource.setUsername("sa");
	    dataSource.setPassword("brijeshwar");
	...
	public SessionFactory sessionFactory() {
		...
		Class classes[]=new Class[]{Product.class,Category.class,Supplier.class,User.class,Customer.class,Authorities.class,BillingAddress.class,ShippingAddress.class,CustomerOrder.class,CartItem.class}; //If product class is not yet created, remove this and add it later
