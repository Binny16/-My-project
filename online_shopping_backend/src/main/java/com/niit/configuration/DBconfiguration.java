...
//to create beans
	...
	public SessionFactory sessionFactory() {
		...
		Class classes[]=new Class[]{Product.class,User.class,cart_items.class,category.class,shipment_address.class,category.class,Orders.class}; //If product class is not yet created, remove this and add it later
